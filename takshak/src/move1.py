...
try:
    ...
    get_img(1)
    move(-0.18159127235412598,-8.385669708251953, 0.9870940065459385,0.16014188159593562)
    get_img(2)
    move(-3.7806596755981445,-4.8448166847229,-0.8522968112740529,0.5230584532268661)
    get_img(2)
    ...
    get_img(3)
    move(4.63737154006958,7.771535873413086,-0.8957202121513852,0.44461815251232994)
    get_img(3)
    count=count1+count2+count3
    print("Count= ",count)
    count=count%5
    print(mp[count])
    move(5.278335094451904,6.775717735290527,-0.12161350128866179,0.992577531633833)
